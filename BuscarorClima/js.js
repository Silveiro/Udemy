...
function buscarClima(e){
    ...
    function mostrarError(mensaje){
        ...
        alerta.classList.add("bg-red-100", "border-red-400", "text-red-700","px-4", "py-3",
         "rounded", "max-w-nd","mx-auto", "mt-6","text-center")
...
function colorFondo(gradosC){
    console.log(gradosC)
    if(gradosC <= 10){
        htm.classList.add("bg-frio")
    }else{
        htm.classList.add("bg-calor")
    }
}
